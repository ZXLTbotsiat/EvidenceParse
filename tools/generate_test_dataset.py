...
CASES = (
    ...
    DatasetCase(
        ...
        "application/pdf",
        ("invoice", "scanned-pdf", "ocr"),
        _write_scanned_pdf,
        _success_expectation(
            source_kind="scanned_pdf",
            **{
                "fields.invoice_number.value": "SYN-IMAGE-01",
                "fields.total.value": "236.00",
    ...
    DatasetCase(
        "image-png",
        "PNG invoice recognized through the OCR pipeline.",
    ...
    DatasetCase(
        "image-jpeg",
        "JPEG invoice recognized through the OCR pipeline.",
